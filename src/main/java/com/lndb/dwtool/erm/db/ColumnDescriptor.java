...
public class ColumnDescriptor {
	...
	if (StringUtils.isNotBlank(getColDefault()) && StringUtils.isNotBlank(other.getColDefault())) {
	    return true;
	}
	return false;
    }
	...
	if (nullable != other.nullable && (StringUtils.isNotBlank(getColDefault()) && nullable))
	    return false;
	return true;
    }
